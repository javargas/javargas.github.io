...
(function bootstrapMetering(conf) {
  (trb.registration || (trb.registration = [])).push(function(reg) {
    ...
    var confBase = { // will overwrite same-named SSOR keys
      ...
      reactionJS: 'chckout002-reaction-1q2w3-18307344204713445856.js',
      rules: conf.rules || [],
